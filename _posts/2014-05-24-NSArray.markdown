...
<p class='protip'><b>PROTIP</b> Use slice instead of first, last, skip and snip… when you have
...
<p class='protip'><b>PROTIP</b> Internally attempts to sort all objects using `-compare:` but if
